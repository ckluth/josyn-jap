...
Part of the **JOSYN** (JobSystem Next) ecosystem — member of the `JOSYN.System`-Schicht.

`JOSYN.System.JAPServer` ist die **Backend-Server-Exe**. Sie startet den JIP-Named-Pipe-Server,
...
```
JOSYN.System.JAPServer.exe JOSYN-IPC <sessionKey>
```
